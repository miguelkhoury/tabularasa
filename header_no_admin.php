<?php
/**
 * The Header for our theme. This one does not have the top admin navigation.
 *
...
// Check if this post or page has the page-banner custom field
    ...
    if (get_post_meta($post->ID, 'page-banner', true)) { ?>
...
<?php } else { ?>
	<div id="header">
</></span><img src="<?php header_image(); ?>" width="<?php echo HEADER_IMAGE_WIDTH; ?>" height="<?php echo HEADER_IMAGE_HEIGHT; ?>" alt="" /></div>
<?php } ?>
</div>
