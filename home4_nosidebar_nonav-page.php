<?php
/**
 * Template Name: 4 Box Home No Sidebar No Nav
 *
...
<?php
  ...
  <?php while ($page_query->have_posts()) : $page_query->the_post(); ?>
  <div class="section"><a href="<?php the_permalink(); ?>" title="<?php the_title_attribute(); ?>" ><?php the_post_thumbnail('thumbnail',array ('class' => 'alignright')); ?></a></a>
    <h2><a href="<?php the_permalink();?>"><?php the_title();?></a></h2>
    <?php the_excerpt(); ?>
